...
namespace Microlight.MicroAudio
{
    ...
    {
        [Header("UI")] [SerializeField] private AudioClip uiClip1;
        [SerializeField] private AudioClip uiClip2;
        [SerializeField] private AudioClip uiClipDelayed;
        [SerializeField] private Slider uiDelaySlider;

        [Header("SFX")] [SerializeField] private AudioClip sfxClip1;
        [SerializeField] private AudioClip sfxClip2;
        [SerializeField] private AudioClip sfxClipDelayed;
        [SerializeField] private Slider sfxDelaySlider;

        [Header("Music")] [SerializeField] private AudioClip musicLoopTrack;
        [SerializeField] private MicroSoundGroup musicGroup;
        ...
        [Header("Volume")] [SerializeField] private Slider masterVolumeSlider;
        [SerializeField] private Slider musicVolumeSlider;
        [SerializeField] private Slider soundsVolumeSlider;
        [SerializeField] private Slider sfxVolumeSlider;
        [SerializeField] private Slider uiVolumeSlider;
        [Space] [SerializeField] private Text masterVolumeText;
        [SerializeField] private Text musicVolumeText;
        [SerializeField] private Text soundsVolumeText;
        [SerializeField] private Text sfxVolumeText;
        [SerializeField] private Text uiVolumeText;

        [Header("Music Status")] [SerializeField]
        private Text track1Text;

        [SerializeField] private Text track2Text;
        [SerializeField] private Text track3Text;
        [SerializeField] private Slider trackProgressSlider;
        [SerializeField] private Slider crossfadeProgressSlider;
        [SerializeField] private Text crossfadeFromTrack;
        [SerializeField] private Text crossfadeToTrack;
        private SoundFade crossfade;

        [Header("Infinity Sounds")] [SerializeField]
        private MicroInfinitySoundGroup microInfinitySoundGroup;

        [SerializeField] private Button playInfinityButton;
        [SerializeField] private Button pauseInfinityButton;
        [SerializeField] private Button stopInfinityButton;

        [Header("Misc")] [SerializeField] private AudioClip checkVolumeClip;

        private DelayedSound volumePingTest; // Tests volume of sound effects when changing value
        private const float pingTestDelay = 0.25f;
        ...
        private void StartVolumeTestPing(int layer)
        {
            ...
            if (layer == 0)
            {
                var src = MicroAudio.PlayUISound(checkVolumeClip, pingTestDelay);
                volumePingTest = MicroAudio.GetDelayStatusOfSound(src);
            }
            else
            {
                var src = MicroAudio.PlayEffectSound(checkVolumeClip, pingTestDelay);
                volumePingTest = MicroAudio.GetDelayStatusOfSound(src);
            }
        }
        ...
        private void UpdatePlaylistTrackNames(List<int> playlist, MicroSoundGroup group)
        {
        ...
        private void MusicPaused(bool isPaused)
        {
            UpdatePlaylistStatus();
        }
        ...
        private void UpdatePlaylistStatus()
        {
            ...
            if (MicroAudio.MusicPlaylistIndex == 0) track1Text.color = Color.cyan;
        ...
        private void CrossfadeStarted(SoundFade fade)
        {
            ...
            if (MicroAudio.CrossfadeAudioSource.clip != null)
                crossfadeFromTrack.text = MicroAudio.CrossfadeAudioSource.clip.name;
            if (MicroAudio.MusicAudioSource.clip != null) crossfadeToTrack.text = MicroAudio.MusicAudioSource.clip.name;
        }

        private void CrossfadeEnded(SoundFade fade)
        {
        ...
        private MicroInfinityInstance infinityInstance;
        ...
        private void InfinitySoundEnded(MicroInfinityInstance instance)
        {
            infinityInstance.OnEnd -= InfinitySoundEnded;
        ...
        public void PauseInfinitySound()
        {
            ...
            if (infinityInstance.IsPaused) infinityInstance.Resume();
